...
LV_IMAGE_DECLARE(battery_01);
LV_IMAGE_DECLARE(battery_02);
LV_IMAGE_DECLARE(battery_03);
LV_IMAGE_DECLARE(battery_04);
LV_IMAGE_DECLARE(battery_05);
LV_IMAGE_DECLARE(battery_06);
...
#if CAN_ANIMATE()
const lv_image_dsc_t *battery_imgs[] = {&battery_01, &battery_02,
                                        &battery_03, &battery_04,
                                        &battery_05, &battery_06};
#endif
...
void animation_smart_battery_on(lv_obj_t *canvas) {
    ...
    lv_image_set_src(art, crystal_imgs_test[0]); // Placeholder
